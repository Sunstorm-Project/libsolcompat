/*
 * Part of libsolcompat sysroot — provides GNU getopt_long interface for Solaris 7
 *
 * Solaris 7 declares getopt() in <stdlib.h> and <unistd.h> but does
 * not provide <getopt.h> or getopt_long()/getopt_long_only().
 */
#ifndef _SOLCOMPAT_SYSROOT_GETOPT_H
#define _SOLCOMPAT_SYSROOT_GETOPT_H
...
#endif /* _SOLCOMPAT_SYSROOT_GETOPT_H */
