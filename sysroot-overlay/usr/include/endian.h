/*
 * Part of libsolcompat sysroot — provides glibc-style byte-order macros for Solaris 7
 *
 * Solaris 7 has no <endian.h>.  Endianness information lives in
 * <sys/isa_defs.h>.  This header provides the glibc/BSD-style macros
 * so portable software builds without modification.
 */
#ifndef _SOLCOMPAT_SYSROOT_ENDIAN_H
#define _SOLCOMPAT_SYSROOT_ENDIAN_H
...
#endif /* _SOLCOMPAT_SYSROOT_ENDIAN_H */
